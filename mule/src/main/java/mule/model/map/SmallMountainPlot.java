 ...
 */
public class SmallMountainPlot extends Plot {
     ...
     */
    public SmallMountainPlot(Canvas rep, int x, int y) {
        super(rep, x, y);
    }

    @Override
    public final void drawBackground() {
        Image image = new Image("mule/view/mountain1.jpg", false);
    ...
    public final boolean produce() {
        if (outfitted() && hasOwner()
            ...
            if (super.getMule().getType().equals(new Food())) {
                ...
                super.getOwner().addResource(new Smithore(), 2);
            }
